...
//
// Only the two UI entry points are re-exported; the profile mutation
// surface (saveProfile/switchProfile/…) stays internal to the module
// so activation.js can't accidentally bypass the QuickPick + modal
// confirmation flow.
