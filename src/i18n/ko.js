...
module.exports = {
  ...
  themeTitle: '에이전트 테마',
  themeAuto: 'Auto (에이전트 따라)', themeClaude: 'Claude Dark', themeKiro: 'Kiro Purple', themeAntigravity: 'Antigravity Spectrum', themeCodex: 'Codex Slate', themeGrok: 'Grok Green',
