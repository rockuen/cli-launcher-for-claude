...
module.exports = {
  ...
  slashOutputStyle: '출력 스타일 변경', slashStatusline: '상태바 설정',
  slashReview: '코드 리뷰', slashPrComments: 'PR 코멘트 확인',
  slashSecurityReview: '보안 리뷰',
  slashAgents: '서브에이전트 관리', slashMcp: 'MCP 서버 상태',
  slashHooks: '훅 설정', slashPermissions: '권한 관리',
  slashIde: 'IDE 통합', slashAddDir: '작업 디렉토리 추가', slashVim: 'Vim 모드 토글',
  ...
  slashUpgrade: '업그레이드', slashMigrateInstaller: '설치 방식 마이그레이션',
