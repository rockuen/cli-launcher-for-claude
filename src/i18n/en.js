...
module.exports = {
  ...
  slashOutputStyle: 'Switch output style', slashStatusline: 'Configure status line',
  slashReview: 'Code review', slashPrComments: 'Check PR comments',
  ...
  slashIde: 'IDE integration', slashAddDir: 'Add working directory', slashVim: 'Toggle Vim mode',
  ...
  slashUpgrade: 'Upgrade installation', slashMigrateInstaller: 'Migrate installer',
